"""
Bu modül, noter ile alınan çıktıları, blender INFO paneline otomatik ekler.

Usage:
    from noter import blender_plug
...
class NOTER_OT_Plug(Operator):
    bl_idname = "noter.reporter"
    bl_label = "Noter for Blender Reporter"
...
def load_handler(dummy):
    bpy.ops.noter.reporter()


register_class(NOTER_OT_Plug)
